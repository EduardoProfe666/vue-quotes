...
export const phrases: PhraseSchema[] = [
  {
    message: [
      ...
      },
      {
        languageId: "es",
        message:
          "Soy egoísta, impaciente y un poco inseguro. Cometo errores, estoy fuera de control y a veces soy difícil de manejar. Pero si no puedes soportarme en mi peor momento, entonces seguro que no mereces tenerme en mi mejor momento.",
      },
    ],
  ...
  },
  {
    message: [
      ...
      },
      {
        languageId: "es",
        message:
          'Dumbledore la observó volar lejos, y mientras su resplandor plateado se desvanecía, se volvió hacia Snape, y sus ojos estaban llenos de lágrimas. "¿Después de todo este tiempo?" "Siempre," dijo Snape.',
      },
    ],
  ...
  },
  {
    message: [
      ...
      },
      {
        languageId: "es",
        message:
          "¿Alguna vez has estado enamorado? Horrible, ¿verdad? Te hace tan vulnerable. Abre tu pecho y abre tu corazón, y significa que alguien puede entrar en ti y desordenarte.",
      },
    ],
    footer: "Neil Gaiman",
    badgeId: "love",
