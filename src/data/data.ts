...
export const metadata: MetadataSchema = {
    ...
    description: [
        {languageId: 'en', message: 'Some beautiful heartbreak quotes'},
        {languageId: 'es', message: 'Algunas frases de desamor hermosas'}
    ],
    url: 'https://heartbreak-vue-quotes.onrender.com',
    language: [
...
export const badges: BadgeSchema[] = [
    {
        ...
        icon: PhHeartBreak,
        background: 'bg-blue-100/90 hover:bg-blue-200/95 transition duration-300 ease-in-out',
        backgroundDark: 'bg-blue-500/20 hover:bg-blue-500/30 transition duration-300 ease-in-out',
        text: 'text-blue-950',
...
export const phrases: PhraseSchema[] = [
    {
        message: [
            {languageId: 'en', message: 'Every time your heart is broken, a doorway cracks open to a world full of new beginnings, new opportunities.'},
            {languageId: 'es', message: 'Cada vez que tu corazón se rompe, una puerta se abre a un mundo lleno de nuevos comienzos y nuevas oportunidades.'}
        ],
    ...
    {
        message: [
            {languageId: 'en', message: 'Hearts will never be practical until they are made unbreakable.'},
            {languageId: 'es', message: 'Los corazones nunca serán prácticos hasta que sean hechos irrompibles.'}
        ],
    ...
    {
        message: [
            {languageId: 'en', message: 'Don\'t cry when the sun is gone, because the tears won\'t let you see the stars.'},
            {languageId: 'es', message: 'No llores cuando el sol se haya ido, porque las lágrimas no te dejarán ver las estrellas.'}
        ],
    ...
    {
        message: [
            {languageId: 'en', message: 'That though the heart is breaking, happiness can exist in a moment, also. And because the moment in which we live is all the time there really is, we can keep going.'},
            {languageId: 'es', message: 'Que aunque el corazón esté roto, la felicidad también puede existir en un momento. Y dado que el momento en el que vivimos es todo el tiempo que realmente hay, podemos seguir adelante.'}
        ],
    ...
    {
        message: [
            {languageId: 'en', message: 'The shattering of a heart when being broken is the loudest quiet ever.'},
            {languageId: 'es', message: 'El quiebre de un corazón al romperse es el silencio más ruidoso que existe.'}
        ],
